...
export default function Home() {
  ...
  return <main><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }} />
    <header className="site-header"><a className="brand" href="#top" aria-label="Mocklet home"><span className="brand-mark">M</span> Mocklet</a><span className="byline">by <a href="https://mikrolyt.com">Mikrolyt</a></span><nav aria-label="Main navigation"><a href="#how-it-works">How it works</a><a href="#case-study">Case study</a><a href="#playground">Try it</a></nav></header>
  ...
  "currency": "IDR"
    ...
    <footer><div className="brand"><span className="brand-mark">M</span> Mocklet</div><p>Build against the contract. Ship with confidence.</p><span className="by-mikrolyt">Part of the <a href="https://mikrolyt.com">Mikrolyt</a> developer tools.</span></footer>
  </main>;
}
