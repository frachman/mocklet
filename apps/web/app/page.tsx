...
export default function Home() {
  ...
  return <main><script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }} />
    <header className="site-header"><div className="topbar-left"><a className="brand" href="https://mikrolyt.com"><span className="brand-mark">M</span><span className="wordmark">Mocklet <small>by Mikrolyt</small><span className="dot">.</span></span></a></div><nav aria-label="Main navigation"><a href="#how-it-works">How it works</a><a href="#case-study">Case study</a><a href="#playground">Try it</a></nav></header><div className="route-stripe" />
